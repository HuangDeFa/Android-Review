...
/**
 * Created by ken.huang on 2/28/2018.
 *
 */
@SuppressLint("NewApi")
        ...
        private static class ImageSaver implements Runnable {
            ...
            public void run() {
                ...
                try {
                    ...
                    //Bitmap bitmap = BitmapFactory.decodeByteArray(bytes,0,bytes.length);//原始的转为Bitmap
                    BitmapFactory.Options op=new BitmapFactory.Options();
                    op.inJustDecodeBounds=false;
                    op.inSampleSize=4;
                    Bitmap bitmapAfter =BitmapFactory.decodeByteArray(bytes,0,bytes.length,op);//压缩

                    //压缩后的Bitmap 转为Bytes
                    ByteArrayOutputStream bos=new ByteArrayOutputStream();
                    bitmapAfter.compress(Bitmap.CompressFormat.JPEG,100,bos);
